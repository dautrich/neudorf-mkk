...
$logoText	= $this->params->get("logoText","COUNTRYSIDE3R");
...
$topmenuPosition = $this->params->get("topmenuPosition", "20");
...
<div id="header" class="container">      
		<div class="row">
			<div id="logo" class="span<?php echo $logoWidth; ?>">
					<h2><?php echo htmlspecialchars($logoText); ?></h2>
...
<!--end of wrap-->
	...
	<div id="a4j" class="container"><a href="http://a4joomla.com/"><?php echo JText::_('TPL_A4JOOMLA-COUNTRYSIDE-FREE_FOOTER_LINK_TEXT');?></a><br/>Angepasst fuer www.neudorf-mkk.de durch den Webmaster</div> 
